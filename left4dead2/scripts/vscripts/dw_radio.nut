...
function SwitchRecords()
{
	...
	//EntFire( EntityGroup[15].GetName(), "playsound", 0 )
}
...
function StopAllMusic()
{
	...
	EntFire( EntityGroup[0].GetName(), "stopsound", 0 )
	...
	EntFire( EntityGroup[6].GetName(), "stopsound", 0 )
	EntFire( EntityGroup[7].GetName(), "stopsound", 0 )
	EntFire( EntityGroup[8].GetName(), "stopsound", 0 )
	EntFire( EntityGroup[9].GetName(), "stopsound", 0 )
	EntFire( EntityGroup[10].GetName(), "stopsound", 0 )
	EntFire( EntityGroup[11].GetName(), "stopsound", 0 )
	EntFire( EntityGroup[12].GetName(), "stopsound", 0 )
	EntFire( EntityGroup[13].GetName(), "stopsound", 0 )
	EntFire( EntityGroup[14].GetName(), "stopsound", 0 )
	EntFire( EntityGroup[15].GetName(), "stopsound", 0 )
}
...
NormalSongList <- SongList( EntityGroup.slice(0, 15+1 ), EntityGroup[8], 2, EntityGroup[6], EntityGroup[15] ) // 5 songs, skins start at 2
