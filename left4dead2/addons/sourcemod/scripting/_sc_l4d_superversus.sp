...
public void OnPluginStart()
{
	...
	AutoJoin = CreateConVar("l4d_autojoin", "2" , "Once a player connects, 2: Put in random team, 1: Show teammenu, 0: Do nothing", CVAR_FLAGS, true, 0.0, true, 2.0);
...
// ------------------------------------------------------------------------
bool l4dt() { if(FindConVar("left4downtown_version") != null && FindConVar("left4downtown_version").FloatValue > 0.0) return true; else return false;}  // Is Left 4 Downtown 1/2 loaded?
