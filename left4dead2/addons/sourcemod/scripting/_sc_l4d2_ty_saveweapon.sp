...
void TySaveSlot1(int client, int iSlot1)
{
	...
	if (g_sWeaponInfo[client][Slot1][0] == '\0')
	{
		...
		else if (StrContains(modelName, "v_pitchfork.mdl",         true) != -1)	g_sWeaponInfo[client][Slot1] = "pitchfork";
		else if (StrContains(modelName, "v_shovel.mdl",         true) != -1)	g_sWeaponInfo[client][Slot1] = "shovel";
...
char survivor_names[10][] = { "Nick", "Rochelle", "Coach", "Ellis", "Bill", "Zoey", "Francis", "Louis", "Zoey", "Francis"};
char survivor_models[10][] =
{
...
public void TyPrecache()
{
	...
	if (!IsModelPrecached("models/weapons/melee/v_pitchfork.mdl")) 			PrecacheModel("models/weapons/melee/v_pitchfork.mdl", true);
	if (!IsModelPrecached("models/weapons/melee/w_pitchfork.mdl")) 			PrecacheModel("models/weapons/melee/w_pitchfork.mdl", true);
	if (!IsModelPrecached("models/weapons/melee/v_shovel.mdl")) 			PrecacheModel("models/weapons/melee/v_shovel.mdl", true);
	if (!IsModelPrecached("models/weapons/melee/w_shovel.mdl")) 			PrecacheModel("models/weapons/melee/w_shovel.mdl", true);
}