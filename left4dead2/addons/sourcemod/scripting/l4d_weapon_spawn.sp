...
#define CONFIG_SPAWNS		"configs/l4d_spawn_weapon.cfg"
...
public void OnPluginStart()
{
	...
	if( g_bLeft4Dead2 )
	{
	g_hCvarGlow =		CreateConVar(	"l4d_weapon_spawn_glow",			"0",			"0=Off. Any other value is the range at which the glow will turn on.", CVAR_FLAGS );
