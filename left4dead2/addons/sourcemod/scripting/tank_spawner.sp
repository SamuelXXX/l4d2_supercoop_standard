...
public void OnPluginStart()
{
	...
	TankWaveDurationCVAR=CreateConVar("tank_wave_duration","30","The duration of tank wave",FCVAR_NOTIFY);
	ShowMsgCVAR=CreateConVar("show_msg","1","Should Log out Message",FCVAR_NOTIFY);
