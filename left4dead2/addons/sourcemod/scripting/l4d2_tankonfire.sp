...
public Plugin:myinfo =
{
	...
	description = "Increase the speed of tanks when on fire in coop.",
...
public OnPluginStart()
{
	...
	h_cvarSpeedBoost = CreateConVar("l4d2_tankfire_boost_amount", "0.95", "Multiplier for tank speed while on fire.", FCVAR_PLUGIN, true, 0.5, true, 2.0);
