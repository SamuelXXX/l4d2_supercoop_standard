...
{
	name = "Bot Invalid Kill Player Command",
	author = "SamaelXXX",
	description = "Bot Invalid Kill Player Command",
	version = "1.0",
...
public void OnPluginStart()
{
	...
	RegAdminCmd("sm_votekill", Command_VoteSlay, ADMFLAG_VOTE|ADMFLAG_SLAY, "sm_voteslay <player>");
